...
//
//                auto shifted_storage = shift_to_equal_scale(left.m_storage, right.m_storage, scale);
//
//                auto result_shifted = storage_addition(shifted_storage.first, shifted_storage.second,
//                                                       left.m_is_positive, right.m_is_positive);
//
//                left.m_storage = unshift_form_equal_scale(result_shifted.first, scale);
...
//                Decimal left{*this};
//                const auto &right = std::get<Decimal>(right_variant);
//                const auto scale_delta = static_cast<int8_t>(left.c_SCALING_FACTOR - right.c_SCALING_FACTOR);
//
//
//                auto shifted_storage = shift_to_equal_scale(left.m_storage, right.m_storage, scale_delta);
//
//                left.m_is_positive ^= !right.m_is_positive;
//
...
//
//                left.m_storage = unshift_form_equal_scale(shifted_storage.first, scale_delta);
//                std::cerr << "Left: " <<left<< " Right: "<< right<<"\n";
//                left.clap_to_size();
//                std::cerr << "Left: " <<left<< " Right: "<< right<<"\n";
//                return left;
...
//                shifted_storage.first /= shifted_storage.second;
//
//                left.m_storage = unshift_form_equal_scale(shifted_storage.first, scale);
//                left.clap_to_size();
//                return left;
//            }
//            case 3: /* === String === */
...
//                const auto &right = std::get<Decimal>(right_variant);
//                auto shifted_storage = shift_to_equal_scale(m_storage, right.m_storage,
