...
namespace itp {
    ...
    std::shared_ptr<num::Number> SymbolTable::get(const std::string &var_name) const{
    ...
    void SymbolTable::set(const std::string &var_name, const std::shared_ptr<num::Number> &var_value) {
